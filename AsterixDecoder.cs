             ...
             foreach (var frn in frnList)
    {
        switch (frn)
        {
            ...
            case 15:
                ...
                break;
            case 16:
                message.WarningErrorConditionsAndTargetClassification = DecodeI048030(reader);
                break;
            case 17:
...
private static ushort ReadUInt16BigEndian(BinaryReader reader)
{
    ...
    return (ushort)((bytes[0] << 8) | bytes[1]);
        ...
        {
            return new I048042 { X = reader.ReadInt16(), Y = reader.ReadInt16() };
        }
    ...
    return data;
        ...
        private static I048090 DecodeI048090(BinaryReader reader)
        {
            ...
            return new I048090
            {
                V = (value & 0x8000) != 0,
                G = (value & 0x4000) != 0,
                FlightLevel = (short)(value & 0x3FFF)
            };
        }
...
private static I048130 DecodeI048130(BinaryReader reader)
{
    ...
    private static I048140 DecodeI048140(BinaryReader reader)
    {
        ...
        uint timeOfDay = (uint)((timeOfDayBytes[0] << 16) | (timeOfDayBytes[1] << 8) | timeOfDayBytes[2]);
