...
public struct I048020
{
    ...
    public override bool Equals(object obj)
    {
        ...
        {
            return TYP == other.TYP && SIM == other.SIM && RDP == other.RDP && SPI == other.SPI && RAB == other.RAB && FX == other.FX && EqualityComparer<List<I048020Extension>>.Default.Equals(Extensions, other.Extensions);
        }
        return false;
    }
    ...
    public void PrintToConsole()
    {
        ...
        Console.WriteLine($"  FX: {FX}\t{(FX == 0 ? "End of Data Item" : "Extension follows")}");
    ...
    public struct I048020Extension
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return TST == other.TST && ERR == other.ERR && XPP == other.XPP && ME == other.ME && MI == other.MI && FOE_FRI == other.FOE_FRI && FX == other.FX;
            }
            return false;
        }
        ...
        public static bool operator ==(I048020Extension left, I048020Extension right) => left.Equals(right);
        public static bool operator !=(I048020Extension left, I048020Extension right) => !(left == right);
    ...
    public struct I048030
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return Code == other.Code && FX == other.FX && EqualityComparer<List<I048030Extension>>.Default.Equals(Extensions, other.Extensions);
            }
            return false;
        }
        ...
        public void PrintToConsole() {
            ...
            Console.WriteLine("Data Item I048/030: Warning/Error Conditions/Target Classification");
    ...
    public struct I048030Extension
    {
        ...
        public static bool operator ==(I048030Extension left, I048030Extension right) => left.Equals(right);
        public static bool operator !=(I048030Extension left, I048030Extension right) => !(left == right);
...
public struct I048040
{
    ...
    public struct I048060
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return QA4 == other.QA4 && QA2 == other.QA2 && QA1 == other.QA1 && QB4 == other.QB4 && QB2 == other.QB2 && QB1 == other.QB1 && QC4 == other.QC4 && QC2 == other.QC2 && QC1 == other.QC1 && QD4 == other.QD4 && QD2 == other.QD2 && QD1 == other.QD1;
            }
            return false;
        }
    ...
    public struct I048065
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return QA4 == other.QA4 && QA2 == other.QA2 && QA1 == other.QA1 && QB2 == other.QB2 && QB1 == other.QB1;
            }
            return false;
        }
    ...
    public struct I048070
{
    ...
    public override bool Equals(object obj)
    {
        ...
        {
            return V == other.V && G == other.G && L == other.L && Mode3ACode == other.Mode3ACode;
        }
        return false;
    }
    ...
    {
        int decimalNumber = 0, placeValue = 1;
        while (octalNumber != 0)
        {
    ...
    public struct I048100
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return V == other.V && G == other.G && ModeCCode == other.ModeCCode && QC1 == other.QC1 && QA1 == other.QA1 && QC2 == other.QC2 && QA2 == other.QA2 && QC4 == other.QC4 && QA4 == other.QA4 && QB1 == other.QB1 && QD1 == other.QD1 && QB2 == other.QB2 && QD2 == other.QD2 && QB4 == other.QB4 && QD4 == other.QD4;
            }
            return false;
        }
   ...
   public struct I048120
{
    ...
    public override bool Equals(object obj)
    {
        if (obj is I048120 other)
        {
            return PrimarySubfield == other.PrimarySubfield &&
                   EqualityComparer<CalculatedDopplerSpeedSubfield?>.Default.Equals(CalculatedDopplerSpeed, other.CalculatedDopplerSpeed) &&
                   EqualityComparer<RawDopplerSpeedSubfield?>.Default.Equals(RawDopplerSpeed, other.RawDopplerSpeed);
        }
        return false;
    }
    ...
    // Print I048/120 Radial Doppler Speed
        ...
        if (CalculatedDopplerSpeed.HasValue)
        {
            ...
            Console.WriteLine($"  Calculated Doppler Speed: {(doppler.IsDoubtful ? "Doubtful" : "Valid")}, Speed: {doppler.Speed}");
        }
...
public struct CalculatedDopplerSpeedSubfield
{
    ...
    public static bool operator ==(CalculatedDopplerSpeedSubfield left, CalculatedDopplerSpeedSubfield right) => left.Equals(right);
    public static bool operator !=(CalculatedDopplerSpeedSubfield left, CalculatedDopplerSpeedSubfield right) => !(left == right);
}
...
public struct RawDopplerSpeedSubfield
{
    ...
    public override bool Equals(object obj)
    {
        ...
        {
            return RepetitionFactor == other.RepetitionFactor && DopplerSpeed == other.DopplerSpeed &&
                   AmbiguityRange == other.AmbiguityRange && TransmitterFrequency == other.TransmitterFrequency;
        }
        return false;
    }
    ...
    public override int GetHashCode()
    {
        return HashCode.Combine(RepetitionFactor, DopplerSpeed, AmbiguityRange, TransmitterFrequency);
    }

    public static bool operator ==(RawDopplerSpeedSubfield left, RawDopplerSpeedSubfield right) => left.Equals(right);
    public static bool operator !=(RawDopplerSpeedSubfield left, RawDopplerSpeedSubfield right) => !(left == right);
}
   ...
   public struct I048130
{
    ...
    public override int GetHashCode()
    {
        return HashCode.Combine(PrimarySubfield, SSRPlotRunlength, NumberOfReceivedReplies,
                                AmplitudeOfReceivedReplies, PSRPlotRunlength, PSRAmplitude,
                                DifferenceInRange, DifferenceInAzimuth);
    }
...
public struct I048170
{
    ...
    public override bool Equals(object obj)
    {
        ...
        {
            return CNF == other.CNF && RAD == other.RAD && DOU == other.DOU && MAH == other.MAH && CDM == other.CDM && FX == other.FX && EqualityComparer<List<I048170Extension>>.Default.Equals(Extensions, other.Extensions);
        }
        return false;
    }
...
public struct I048170Extension
{
    ...
    public override bool Equals(object obj)
    {
        ...
        {
            return TRE == other.TRE && GHO == other.GHO && SUP == other.SUP && TCC == other.TCC && FX == other.FX;
        }
        return false;
    }
    ...
    public static bool operator ==(I048170Extension left, I048170Extension right) => left.Equals(right);
    public static bool operator !=(I048170Extension left, I048170Extension right) => !(left == right);
    ...
    public struct I048200
    {
        ...
        public void PrintToConsole(){
            ...
            Console.WriteLine("Data Item I048/200: Calculated Track Velocity in Polar Representation");
    ...
    public struct I048210
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return SigmaX == other.SigmaX && SigmaY == other.SigmaY && SigmaV == other.SigmaV && SigmaH == other.SigmaH;
            }
            return false;
        }
    ...
    public struct I048220
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return EqualityComparer<byte[]>.Default.Equals(AircraftAddress, other.AircraftAddress);
            }
            return false;
        }
    ...
    public struct I048230
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return COM == other.COM && STAT == other.STAT && SI == other.SI && MSSC == other.MSSC && ARC == other.ARC && AIC == other.AIC && B1A == other.B1A && B1B == other.B1B;
            }
            return false;
        }
    ...
    // Print I048/230 Communications/ACAS Capability and Flight Status
        Console.WriteLine("Data Item I048/230: Communications/ACAS Capability and Flight Status");
    ...
    public struct I048250
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return REP == other.REP && EqualityComparer<List<BDSRegister>>.Default.Equals(BDSRegisters, other.BDSRegisters);
            }
            return false;
        }
    ...
    public struct BDSRegister
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return EqualityComparer<byte[]>.Default.Equals(BDSData, other.BDSData) && BDS1 == other.BDS1 && BDS2 == other.BDS2;
            }
            return false;
        }
        ...
        public void PrintToConsole()
    {
        ...
        if (FRNList.Contains(1)) DataSourceIdentifier.PrintToConsole();
        if (FRNList.Contains(2)) TimeOfDay.PrintToConsole();
        if (FRNList.Contains(3)) TargetReportAndTargetCapabilities.PrintToConsole();
        if (FRNList.Contains(4)) MeasuredPositionPolar.PrintToConsole();
        if (FRNList.Contains(5)) Mode3ACode.PrintToConsole();
        if (FRNList.Contains(6)) FlightLevel.PrintToConsole();
        if (FRNList.Contains(7)) RadarPlotCharacteristics.PrintToConsole();
        if (FRNList.Contains(8)) AircraftAddress.PrintToConsole();
        if (FRNList.Contains(9)) AircraftIdentification.PrintToConsole();
        if (FRNList.Contains(10)) BDSRegisterData.PrintToConsole();
        if (FRNList.Contains(11)) TrackNumber.PrintToConsole();
        if (FRNList.Contains(12)) CalculatedPositionCartesian.PrintToConsole();
        if (FRNList.Contains(13)) CalculatedTrackVelocityPolar.PrintToConsole();
        if (FRNList.Contains(14)) TrackStatus.PrintToConsole();
        if (FRNList.Contains(15)) TrackQuality.PrintToConsole();
        if (FRNList.Contains(16)) WarningErrorConditionsAndTargetClassification.PrintToConsole();
        if (FRNList.Contains(17)) Mode3ACodeConfidence.PrintToConsole();
        if (FRNList.Contains(18)) ModeCCodeAndConfidence.PrintToConsole();
        if (FRNList.Contains(19)) HeightMeasuredBy3DRadar.PrintToConsole();
        if (FRNList.Contains(20)) RadialDopplerSpeed.PrintToConsole();
        if (FRNList.Contains(21)) CommunicationsACASCapabilityAndFlightStatus.PrintToConsole();
        if (FRNList.Contains(22)) ACASResolutionAdvisoryReport.PrintToConsole();
        if (FRNList.Contains(23)) Mode1Code.PrintToConsole();
        ...
        public override bool Equals(object obj)
        {
            if (obj is AsterixCat048Message other)
            {
                return Category == other.Category &&
                       ...
                       TargetReportAndTargetCapabilities.Equals(other.TargetReportAndTargetCapabilities) &&
                       WarningErrorConditionsAndTargetClassification.Equals(other.WarningErrorConditionsAndTargetClassification) &&
                       ...
                       CommunicationsACASCapabilityAndFlightStatus.Equals(other.CommunicationsACASCapabilityAndFlightStatus) &&
                       ...
                       EqualityComparer<List<AdditionalField>>.Default.Equals(AdditionalFields, other.AdditionalFields);
            }
            return false;
        }
        ...
        public override int GetHashCode()
        {
            int hash1 = HashCode.Combine(DataSourceIdentifier, TargetReportAndTargetCapabilities, WarningErrorConditionsAndTargetClassification, MeasuredPositionPolar, CalculatedPositionCartesian, Mode2Code, Mode1Code);
            int hash2 = HashCode.Combine(Mode2CodeConfidence, Mode1CodeConfidence, Mode3ACode, Mode3ACodeConfidence, FlightLevel, ModeCCodeAndConfidence, HeightMeasuredBy3DRadar, RadialDopplerSpeed);
            int hash3 = HashCode.Combine(RadarPlotCharacteristics, TimeOfDay, TrackNumber, TrackStatus, CalculatedTrackVelocityPolar, TrackQuality, AircraftAddress, CommunicationsACASCapabilityAndFlightStatus);
            int hash4 = HashCode.Combine(AircraftIdentification, BDSRegisterData, ACASResolutionAdvisoryReport, AdditionalFields);
            return HashCode.Combine(hash1, hash2, hash3, hash4);
        }

        public static bool operator ==(AsterixCat048Message left, AsterixCat048Message right) => left.Equals(right);
        public static bool operator !=(AsterixCat048Message left, AsterixCat048Message right) => !(left == right);
    }
    ...
    public struct AdditionalField
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return FieldNumber == other.FieldNumber && EqualityComparer<object>.Default.Equals(Value, other.Value);
            }
            return false;
        }
        ...
        public static bool operator ==(AdditionalField left, AdditionalField right) => left.Equals(right);
        public static bool operator !=(AdditionalField left, AdditionalField right) => !(left == right);
    }
}
